...
*This is Part 3 of my ongoing series on the Microsoft Cloud Adoption Framework. [Part 1 covered the CAF overview](./AzurecloudAdoption.md). [Part 2 went deep on Azure Landing Zones design areas](./azlzdesignAreas.md). Next up: Governance — Azure Policy as Code without killing developer agility.*
